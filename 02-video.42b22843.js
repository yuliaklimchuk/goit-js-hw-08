...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("iframe"),o=new Vimeo.Player(r);let l;const n=localStorage.getItem("videoplayer-current-time");n&&o.setCurrentTime(n),o.on("timeupdate",(0,e.default)(function(e){l=e.seconds,localStorage.setItem("videoplayer-current-time",l)},1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.42b22843.js.map
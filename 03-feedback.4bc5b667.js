...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),l=document.querySelector("input[name=email]"),u=document.querySelector("textarea[name=message]"),r=JSON.parse(localStorage.getItem("feedback-form-state"));function o(){let e=n(l.value,u.value);localStorage.setItem("feedback-form-state",JSON.stringify(e))}function n(e,t){return{email:e,message:t}}function c(e){e.preventDefault(),console.log(n(l.value,u.value)),l.value="",u.value="",localStorage.clear()}r&&(l.value=r.email,u.value=r.message),a.addEventListener("input",(0,e.default)(o,500)),a.addEventListener("submit",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.4bc5b667.js.map